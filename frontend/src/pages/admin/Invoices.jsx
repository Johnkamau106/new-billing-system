                    ...
                    <tbody className="text-gray-600 text-sm font-light">
                        {invoices.map(invoice => (
                            <tr key={invoice.id} className="border-b border-gray-200 hover:bg-gray-100">
                                ...
                                <td className="py-3 px-6 text-left">{invoice.client_id}</td>
                                ...
                                <td className="py-3 px-6 text-center">
                                    <Link to={`/invoices/${invoice.id}`} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                                        View
                                    </Link>
                                </td>
                            </tr>
